...
void	check_mapv2(t_list *s, char *file, int fd)
{
	...
	s->img_wall = mlx_xpm_file_to_image(s->ptr, "bedrock.xpm", &s->a, &s->b);
	s->img_grass = mlx_xpm_file_to_image(s->ptr, "dirt.xpm", &s->a, &s->b);
	s->img_cake = mlx_xpm_file_to_image(s->ptr, "cake.xpm", &s->a, &s->b);
	s->img_portal = mlx_xpm_file_to_image(s->ptr, "portal.xpm", &s->a, &s->b);
	s->img_plyer = mlx_xpm_file_to_image(s->ptr, "player.xpm", &s->a, &s->b);
	s->img_enemy = mlx_xpm_file_to_image(s->ptr, "enemy.xpm", &s->a, &s->b);
}
